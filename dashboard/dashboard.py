...
def display_monthly_trend_line(filtered_data, selected_district):
    ...
    # Create line chart using st.line_chart for SO2, O3, and NO2
...
def display_monthly_trend_co(filtered_data, selected_district):
    ...
    # Create line chart using st.line_chart for CO
...
def main():
    ...
    display_monthly_trend_co(filtered_data, selected_district)  # Menampilkan grafik CO terpisah
